    ...
    \begin{center}
        ...
        \begin{table}[h]
            ...
            \begin{tabular}{ll}
                ...
                \textbf{Tutors:} & Sara Vecino García \\
...
\include{chapters/proof_authority}
\newpage
...
\include{chapters/experiment_execution}
...
\include{chapters/project_budget}
\include{chapters/client_budget}
\include{chapters/rgpd}
