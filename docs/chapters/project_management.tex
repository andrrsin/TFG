...
\begin{table} [H]
    ...
    \begin{tabularx}{\textwidth} { 
        ...
        \textbf{01/05/2026} & Pywib early version problems & After contacting with the current mantainer and the early versions of the program,
                              It was decided to stop the use of this hci library develeopded in Uniovi. Worht keeping an eye on in the future. \\ \hline
    \end{tabularx}
\end{table}