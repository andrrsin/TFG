...
\end{table}
Given the information of tables above, the total budget for the client project that will be further explained in appendix 
\ref{chap:client_budget} is calculated in table \ref{tab:margin}. The cost for the client is calculated by adding the results of
multiplying the estimated cost by the percentage to share with the clients. This percentage is obtained 
by dividing the sum of the benefits and the indirect cost of "PRevious Planning and State of the Art" by
the total cost of the project minus these indirect costs.
% Tabla Budget
\begin{table} [H]
    \centering
    \begin{tabular}{|p{6.5cm}|c|c|}
        \hline
        \textbf{Part} & \textbf{Cost (\euro)} & \textbf{Cost for client (\euro)}\\ \hline
        \textbf{1. Previous Planning and State of the Art} & 6,622.50 & \\ \hline
            1.1 Previous Planning & 1,005.00 & \\ \hline
            1.2 State of the Art & 5,617.50 & \\ \hline
        \textbf{2. Experiment} & 13,588.75 & 23,991.57 \\ \hline
            2.1 Experiment Proposal & 2,943.75 & 5,197.33 \\ \hline
            2.2 Experiment Development & 2,722.50 & 4,806.70 \\ \hline 
            2.3 Experiment Data Analysis & 7,922.50 & 13,987.54 \\ \hline
        \textbf{3. Documentation for the paper} & 3,041.25 & 5,369.47 \\ \hline
        \textbf{Total} & 23,252.50 & 29,361.04 \\ \hline
        \textbf{Total with Benefits} & 29,065.63 & \\ \hline
        \textbf{Contingency} & 295.42 & \\ \hline
        \textbf{Benefits} & 6,108.54 &  \\ \hline
        \textbf{Percentage to share with client} & 76.55\% &  \\ \hline
    \end{tabular}
    \caption{Final budget of the project}
    \label{tab:margin}
\end{table}